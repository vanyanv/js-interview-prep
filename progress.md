...
- [ ] easy-05-merge-sorted-arrays
- [ ] easy-06-move-zeros
- [ ] easy-07-remove-duplicates
- [ ] easy-08-remove-element
- [ ] easy-09-reverse-string
- [ ] easy-10-reverse-vowels
- [ ] easy-11-squares-sorted-array
...
- [ ] medium-04-four-sum
- [ ] medium-05-interval-list-intersections
- [ ] medium-06-next-permutation
- [ ] medium-07-partition-labels
- [ ] medium-08-shortest-unsorted-subarray
- [ ] medium-09-sort-colors
- [ ] medium-10-three-sum-closest
- [ ] medium-11-three-sum
...
- [ ] medium-04-longest-substring-k-repeat
- [ ] medium-05-max-consecutive-ones-iii
- [ ] medium-06-minimum-window-substring
- [ ] medium-07-number-of-substrings
- [ ] medium-08-permutation-in-string
- [ ] medium-09-replace-substring
- [ ] medium-10-smallest-window-subsequence
- [ ] medium-11-subarrays-k-different
- [ ] medium-12-substring-concatenation
- [ ] medium-13-substring-with-concatenation
- [ ] medium-14-substring-k-distinct
- [ ] medium-15-substrings-all-three
- [ ] medium-16-substrings-exactly-k
...
- [ ] easy-04-design-hashset
- [ ] easy-05-find-difference
- [ ] easy-06-intersection-two-arrays
- [ ] easy-07-intersection-two-arrays-ii
- [ ] easy-08-isomorphic-strings
- [ ] easy-09-jewels-and-stones
- [ ] easy-10-majority-element
- [ ] easy-11-missing-number
- [ ] easy-12-ransom-note
- [ ] easy-13-single-number
- [ ] easy-14-two-sum
- [ ] easy-15-uncommon-words
- [ ] easy-16-unique-morse-code
...
- [ ] medium-04-group-anagrams
- [ ] medium-05-insert-delete-getrandom
- [ ] medium-06-lru-cache
- [ ] medium-07-subarray-sum-equals-k
- [ ] medium-08-task-scheduler
- [ ] medium-09-top-k-frequent-elements
- [ ] medium-10-top-k-frequent-words
...
- [ ] easy-04-middle-linked-list
- [ ] easy-05-palindrome-linked-list
...
- [ ] medium-04-partition-list
- [ ] medium-05-remove-nth-node
- [ ] medium-06-reorder-list
- [ ] medium-07-rotate-list
- [ ] medium-08-sort-list
...
- [ ] easy-04-min-stack
- [ ] easy-05-next-greater-element-i
- [ ] easy-06-remove-all-adjacent-duplicates
- [ ] easy-07-remove-outermost-parentheses
- [ ] easy-08-score-of-parentheses
...
- [ ] medium-04-next-greater-element-ii
- [ ] medium-05-online-stock-span
- [ ] medium-06-remove-duplicate-letters
- [ ] medium-07-simplify-path
- [ ] medium-08-sum-subarray-minimums
...
- [ ] easy-04-intersection-two-arrays
- [ ] easy-05-sqrt-x
...
- [ ] medium-04-find-peak-element
- [ ] medium-05-koko-eating-bananas
- [ ] medium-06-search-2d-matrix
- [ ] medium-07-search-insert-position
- [ ] medium-08-search-rotated-sorted-array
...
- [ ] easy-04-count-good-nodes
- [ ] easy-05-factorial
- [ ] easy-06-fibonacci
- [ ] easy-07-invert-binary-tree
- [ ] easy-08-maximum-depth-binary-tree
- [ ] easy-09-merge-two-sorted-lists
- [ ] easy-10-path-sum
- [ ] easy-11-same-tree
- [ ] easy-12-search-binary-search-tree
...
- [ ] medium-04-jump-game
- [ ] medium-05-longest-increasing-subsequence
- [ ] medium-06-longest-palindromic-substring
- [ ] medium-07-maximum-product-subarray
- [ ] medium-08-maximum-subarray
- [ ] medium-09-min-cost-climbing-stairs
- [ ] medium-10-palindromic-substrings
- [ ] medium-11-partition-equal-subset-sum
- [ ] medium-12-unique-paths
- [ ] medium-13-unique-paths-ii
...
- [ ] easy-04-reverse-integer
- [ ] easy-05-valid-parentheses-mixed
- [ ] easy-06-longest-common-prefix
- [ ] easy-07-remove-duplicates-sorted-array
- [ ] easy-08-implement-strstr
- [ ] easy-09-search-insert-position-mixed
- [ ] easy-10-length-last-word
- [ ] easy-11-plus-one
- [ ] easy-12-add-binary
- [ ] easy-13-sqrt-x-mixed
- [ ] easy-14-climbing-stairs-mixed
...
- [ ] medium-04-number-of-islands
- [ ] medium-05-course-schedule
- [ ] medium-06-decode-string
- [ ] medium-07-target-sum
...
- [ ] hard-03-n-queens
- [ ] hard-04-word-ladder-ii
- [ ] hard-05-longest-valid-parentheses
- [ ] hard-06-sudoku-solver
- [ ] hard-07-text-justification
- [ ] hard-08-minimum-window-substring-mixed
...
- **Hard Problems:** 0/26 (advanced algorithms + hard mixed)
- **Patterns Mastered:** 0/9
...
- **Phase 4 (Algorithms):** 0/35 problems (15 recursion + 20 dynamic-programming)
- **Phase 5 (Interview Ready):** 0/33 problems (33 mixed-practice)
