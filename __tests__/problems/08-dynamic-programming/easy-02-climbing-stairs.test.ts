// Auto-generated from problems/08-dynamic-programming/easy-02-climbing-stairs.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/08-dynamic-programming/easy-02-climbing-stairs.js';

const solutionFn = undefined;

describe('easy-02-climbing-stairs [problems/08-dynamic-programming]', () => {
  if (!solutionFn) {
