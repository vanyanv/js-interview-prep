// Auto-generated from problems/08-dynamic-programming/medium-05-house-robber.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/08-dynamic-programming/medium-05-house-robber.js';

const solutionFn = undefined;

describe('medium-05-house-robber [problems/08-dynamic-programming]', () => {
  if (!solutionFn) {
