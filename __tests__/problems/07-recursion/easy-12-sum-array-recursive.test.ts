// Auto-generated from problems/07-recursion/easy-12-sum-array-recursive.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/07-recursion/easy-12-sum-array-recursive.js';

const solutionFn = undefined;

describe('easy-12-sum-array-recursive [problems/07-recursion]', () => {
  if (!solutionFn) {
