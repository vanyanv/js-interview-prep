// Auto-generated from problems/07-recursion/easy-01-binary-tree-inorder.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/07-recursion/easy-01-binary-tree-inorder.js';

const solutionFn = undefined;

describe('easy-01-binary-tree-inorder [problems/07-recursion]', () => {
  if (!solutionFn) {
