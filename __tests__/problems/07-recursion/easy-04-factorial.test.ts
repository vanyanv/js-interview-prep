// Auto-generated from problems/07-recursion/easy-04-factorial.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/07-recursion/easy-04-factorial.js';

const solutionFn = undefined;

describe('easy-04-factorial [problems/07-recursion]', () => {
  if (!solutionFn) {
