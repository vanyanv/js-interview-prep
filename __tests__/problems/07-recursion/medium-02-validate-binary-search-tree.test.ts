// Auto-generated from problems/07-recursion/medium-02-validate-binary-search-tree.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/07-recursion/medium-02-validate-binary-search-tree.js';

const solutionFn = undefined;

describe('medium-02-validate-binary-search-tree [problems/07-recursion]', () => {
  if (!solutionFn) {
