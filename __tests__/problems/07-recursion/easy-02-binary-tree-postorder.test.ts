// Auto-generated from problems/07-recursion/easy-02-binary-tree-postorder.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/07-recursion/easy-02-binary-tree-postorder.js';

const solutionFn = undefined;

describe('easy-02-binary-tree-postorder [problems/07-recursion]', () => {
  if (!solutionFn) {
