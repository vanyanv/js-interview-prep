// Auto-generated from problems/07-recursion/easy-06-maximum-depth-binary-tree.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/07-recursion/easy-06-maximum-depth-binary-tree.js';

const solutionFn = undefined;

describe('easy-06-maximum-depth-binary-tree [problems/07-recursion]', () => {
  if (!solutionFn) {
