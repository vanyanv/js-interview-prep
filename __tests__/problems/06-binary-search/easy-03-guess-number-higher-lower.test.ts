// Auto-generated from problems/06-binary-search/easy-03-guess-number-higher-lower.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/06-binary-search/easy-03-guess-number-higher-lower.js';

const solutionFn = undefined;

describe('easy-03-guess-number-higher-lower [problems/06-binary-search]', () => {
  if (!solutionFn) {
