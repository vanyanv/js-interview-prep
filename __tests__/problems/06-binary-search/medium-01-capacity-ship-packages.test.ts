// Auto-generated from problems/06-binary-search/medium-01-capacity-ship-packages.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/06-binary-search/medium-01-capacity-ship-packages.js';

const solutionFn = undefined;

describe('medium-01-capacity-ship-packages [problems/06-binary-search]', () => {
  if (!solutionFn) {
