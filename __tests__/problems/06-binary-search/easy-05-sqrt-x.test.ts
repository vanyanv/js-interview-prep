// Auto-generated from problems/06-binary-search/easy-05-sqrt-x.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/06-binary-search/easy-05-sqrt-x.js';

const solutionFn = undefined;

describe('easy-05-sqrt-x [problems/06-binary-search]', () => {
  if (!solutionFn) {
