// Auto-generated from problems/06-binary-search/easy-02-first-bad-version.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/06-binary-search/easy-02-first-bad-version.js';

const solutionFn = undefined;

describe('easy-02-first-bad-version [problems/06-binary-search]', () => {
  if (!solutionFn) {
