// Auto-generated from problems/06-binary-search/hard-01-split-array-largest-sum.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/06-binary-search/hard-01-split-array-largest-sum.js';

const solutionFn = undefined;

describe('hard-01-split-array-largest-sum [problems/06-binary-search]', () => {
  if (!solutionFn) {
