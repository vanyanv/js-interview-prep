// Auto-generated from problems/03-hash-maps/hard-03-first-missing-positive.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/03-hash-maps/hard-03-first-missing-positive.js';

const solutionFn = undefined;

describe('hard-03-first-missing-positive [problems/03-hash-maps]', () => {
  if (!solutionFn) {
