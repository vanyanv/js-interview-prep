// Auto-generated from problems/03-hash-maps/hard-01-minimum-window-substring.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/03-hash-maps/hard-01-minimum-window-substring.js';

const solutionFn = undefined;

describe('hard-01-minimum-window-substring [problems/03-hash-maps]', () => {
  if (!solutionFn) {
