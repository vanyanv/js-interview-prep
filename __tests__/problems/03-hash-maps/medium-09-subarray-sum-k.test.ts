// Auto-generated from problems/03-hash-maps/medium-09-subarray-sum-k.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/03-hash-maps/medium-09-subarray-sum-k.js';

const solutionFn = undefined;

describe('medium-09-subarray-sum-k [problems/03-hash-maps]', () => {
  if (!solutionFn) {
