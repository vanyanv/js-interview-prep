// Auto-generated from problems/03-hash-maps/medium-06-longest-consecutive.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/03-hash-maps/medium-06-longest-consecutive.js';

const solutionFn = undefined;

describe('medium-06-longest-consecutive [problems/03-hash-maps]', () => {
  if (!solutionFn) {
