// Auto-generated from problems/03-hash-maps/medium-02-find-duplicates.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/03-hash-maps/medium-02-find-duplicates.js';

const solutionFn = undefined;

describe('medium-02-find-duplicates [problems/03-hash-maps]', () => {
  if (!solutionFn) {
