// Auto-generated from problems/02-sliding-window/medium-14-permutation-in-string.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/02-sliding-window/medium-14-permutation-in-string.js';

const solutionFn = undefined;

describe('medium-14-permutation-in-string [problems/02-sliding-window]', () => {
  if (!solutionFn) {
