// Auto-generated from problems/02-sliding-window/easy-01-average-subarrays-k.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/02-sliding-window/easy-01-average-subarrays-k.js';

let solutionFn: ((...args: any[]) => any) | undefined;
try {
  const mod = await import('./../../../solutions/easy-01-average-subarrays-k.ts');
  solutionFn = mod[functionName] ?? mod.default;
} catch {
  // Solution not found — tests will be skipped
}

describe('easy-01-average-subarrays-k [problems/02-sliding-window]', () => {
  if (!solutionFn) {
