// Auto-generated from problems/02-sliding-window/easy-07-minimum-difference.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/02-sliding-window/easy-07-minimum-difference.js';

const solutionFn = undefined;

describe('easy-07-minimum-difference [problems/02-sliding-window]', () => {
  if (!solutionFn) {
