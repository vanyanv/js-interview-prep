// Auto-generated from problems/02-sliding-window/medium-05-k-length-substrings.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/02-sliding-window/medium-05-k-length-substrings.js';

const solutionFn = undefined;

describe('medium-05-k-length-substrings [problems/02-sliding-window]', () => {
  if (!solutionFn) {
