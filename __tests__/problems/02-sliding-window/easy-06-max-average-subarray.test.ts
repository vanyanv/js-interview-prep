// Auto-generated from problems/02-sliding-window/easy-06-max-average-subarray.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/02-sliding-window/easy-06-max-average-subarray.js';

const solutionFn = undefined;

describe('easy-06-max-average-subarray [problems/02-sliding-window]', () => {
  if (!solutionFn) {
