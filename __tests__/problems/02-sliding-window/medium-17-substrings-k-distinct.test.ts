// Auto-generated from problems/02-sliding-window/medium-17-substrings-k-distinct.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/02-sliding-window/medium-17-substrings-k-distinct.js';

const solutionFn = undefined;

describe('medium-17-substrings-k-distinct [problems/02-sliding-window]', () => {
  if (!solutionFn) {
