// Auto-generated from problems/02-sliding-window/easy-02-contains-duplicate-ii.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/02-sliding-window/easy-02-contains-duplicate-ii.js';

let solutionFn: ((...args: any[]) => any) | undefined;
try {
  const mod = await import('./../../../solutions/easy-02-contains-duplicate-ii.ts');
  solutionFn = mod[functionName] ?? mod.default;
} catch {
  // Solution not found — tests will be skipped
}

describe('easy-02-contains-duplicate-ii [problems/02-sliding-window]', () => {
  if (!solutionFn) {
