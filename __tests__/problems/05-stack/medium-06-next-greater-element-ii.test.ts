// Auto-generated from problems/05-stack/medium-06-next-greater-element-ii.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/05-stack/medium-06-next-greater-element-ii.js';

const solutionFn = undefined;

describe('medium-06-next-greater-element-ii [problems/05-stack]', () => {
  if (!solutionFn) {
