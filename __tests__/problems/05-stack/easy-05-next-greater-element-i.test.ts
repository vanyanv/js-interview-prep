// Auto-generated from problems/05-stack/easy-05-next-greater-element-i.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/05-stack/easy-05-next-greater-element-i.js';

const solutionFn = undefined;

describe('easy-05-next-greater-element-i [problems/05-stack]', () => {
  if (!solutionFn) {
