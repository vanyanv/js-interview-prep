// Auto-generated from problems/05-stack/easy-01-backspace-string-compare.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/05-stack/easy-01-backspace-string-compare.js';
...
describe('easy-01-backspace-string-compare [problems/05-stack]', () => {
  if (!solutionFn) {
