// Auto-generated from problems/09-mixed-practice/medium-06-course-schedule.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/09-mixed-practice/medium-06-course-schedule.js';

const solutionFn = undefined;

describe('medium-06-course-schedule [problems/09-mixed-practice]', () => {
  if (!solutionFn) {
