// Auto-generated from problems/09-mixed-practice/easy-14-move-zeros-to-end.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/09-mixed-practice/easy-14-move-zeros-to-end.js';

const solutionFn = undefined;

describe('easy-14-move-zeros-to-end [problems/09-mixed-practice]', () => {
  if (!solutionFn) {
