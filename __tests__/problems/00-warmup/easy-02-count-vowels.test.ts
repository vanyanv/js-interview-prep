// Auto-generated from problems/00-warmup/easy-02-count-vowels.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/00-warmup/easy-02-count-vowels.js';

let solutionFn: ((...args: any[]) => any) | undefined;
try {
  const mod = await import('./../../../solutions/easy-02-count-vowels.js');
  solutionFn = mod[functionName] ?? mod.default;
} catch {
  // Solution not found — tests will be skipped
}

describe('easy-02-count-vowels [problems/00-warmup]', () => {
  if (!solutionFn) {
