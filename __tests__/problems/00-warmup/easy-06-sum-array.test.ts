// Auto-generated from problems/00-warmup/easy-06-sum-array.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/00-warmup/easy-06-sum-array.js';

let solutionFn: ((...args: any[]) => any) | undefined;
try {
  const mod = await import('./../../../solutions/easy-06-sum-array.js');
  solutionFn = mod[functionName] ?? mod.default;
} catch {
  // Solution not found — tests will be skipped
}

describe('easy-06-sum-array [problems/00-warmup]', () => {
  if (!solutionFn) {
