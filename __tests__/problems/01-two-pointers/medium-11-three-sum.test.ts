// Auto-generated from problems/01-two-pointers/medium-11-three-sum.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/01-two-pointers/medium-11-three-sum.js';

const solutionFn = undefined;

describe('medium-11-three-sum [problems/01-two-pointers]', () => {
  if (!solutionFn) {
