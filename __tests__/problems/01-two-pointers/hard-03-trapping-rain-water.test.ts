// Auto-generated from problems/01-two-pointers/hard-03-trapping-rain-water.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/01-two-pointers/hard-03-trapping-rain-water.js';

const solutionFn = undefined;

describe('hard-03-trapping-rain-water [problems/01-two-pointers]', () => {
  if (!solutionFn) {
