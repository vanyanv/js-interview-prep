// Auto-generated from problems/01-two-pointers/easy-04-long-pressed-name.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/01-two-pointers/easy-04-long-pressed-name.js';

let solutionFn: ((...args: any[]) => any) | undefined;
try {
  const mod = await import('./../../../solutions/easy-04-long-pressed-name.ts');
  solutionFn = mod[functionName] ?? mod.default;
} catch {
  // Solution not found — tests will be skipped
}

describe('easy-04-long-pressed-name [problems/01-two-pointers]', () => {
  if (!solutionFn) {
