// Auto-generated from problems/01-two-pointers/medium-06-next-permutation.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/01-two-pointers/medium-06-next-permutation.js';

const solutionFn = undefined;

describe('medium-06-next-permutation [problems/01-two-pointers]', () => {
  if (!solutionFn) {
