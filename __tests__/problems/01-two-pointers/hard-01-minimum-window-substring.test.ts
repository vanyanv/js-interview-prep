// Auto-generated from problems/01-two-pointers/hard-01-minimum-window-substring.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/01-two-pointers/hard-01-minimum-window-substring.js';

const solutionFn = undefined;

describe('hard-01-minimum-window-substring [problems/01-two-pointers]', () => {
  if (!solutionFn) {
