// Auto-generated from problems/01-two-pointers/medium-02-compare-version-numbers.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/01-two-pointers/medium-02-compare-version-numbers.js';

const solutionFn = undefined;

describe('medium-02-compare-version-numbers [problems/01-two-pointers]', () => {
  if (!solutionFn) {
