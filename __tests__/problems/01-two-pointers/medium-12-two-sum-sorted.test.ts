// Auto-generated from problems/01-two-pointers/medium-12-two-sum-sorted.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/01-two-pointers/medium-12-two-sum-sorted.js';

let solutionFn: ((...args: any[]) => any) | undefined;
try {
  const mod = await import('./../../../solutions/medium-12-two-sum-sorted.ts');
  solutionFn = mod[functionName] ?? mod.default;
} catch {
  // Solution not found — tests will be skipped
}

describe('medium-12-two-sum-sorted [problems/01-two-pointers]', () => {
  if (!solutionFn) {
