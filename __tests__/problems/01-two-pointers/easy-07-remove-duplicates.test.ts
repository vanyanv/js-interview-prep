// Auto-generated from problems/01-two-pointers/easy-07-remove-duplicates.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/01-two-pointers/easy-07-remove-duplicates.js';

let solutionFn: ((...args: any[]) => any) | undefined;
try {
  const mod = await import('./../../../solutions/easy-07-remove-duplicates.ts');
  solutionFn = mod[functionName] ?? mod.default;
} catch {
  // Solution not found — tests will be skipped
}

describe('easy-07-remove-duplicates [problems/01-two-pointers]', () => {
  if (!solutionFn) {
