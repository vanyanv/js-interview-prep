// Auto-generated from problems/01-two-pointers/easy-01-backspace-string-compare.js
// Re-run: npm run generate:tests
import { describe, it, expect } from 'vitest';
import { functionName, tests } from './../../../problems/01-two-pointers/easy-01-backspace-string-compare.js';

let solutionFn: ((...args: any[]) => any) | undefined;
try {
  const mod = await import('./../../../solutions/easy-01-backspace-string-compare.js');
  solutionFn = mod[functionName] ?? mod.default;
} catch {
  // Solution not found — tests will be skipped
}

describe('easy-01-backspace-string-compare [problems/01-two-pointers]', () => {
  if (!solutionFn) {
